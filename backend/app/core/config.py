...
class Settings(BaseSettings):
    ...
    CONTENT_MODEL: str = "gemini/gemini-3.6-flash"
    STORY_MODEL: str = "gemini/gemini-3.6-flash"
    MEMORY_MODEL: str = "gemini/gemini-3.6-flash"
    RECOMMENDATION_MODEL: str = "gemini/gemini-3.6-flash"
